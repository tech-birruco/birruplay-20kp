      ...
      <div className="absolute inset-0 bg-gradient-to-r from-primary-50 to-accent-50 opacity-50"></div>
        <div className="relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            <span className="text-primary-600">Bebas Speech Delay</span> <br />
            {' '} Karena Bisa Nyusun Kalimat
          </h1>
          <p className="text-xl text-gray-700 mb-8">
          Berbasis kurikulum international, bantu percepat kemampuan anak menyusun kalimat lengkap, <br />menceritakan hal di sekitarnya, dan membangun koneksi lebih dekat dengan Ayah Bunda
          </p>
